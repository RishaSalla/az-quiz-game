  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-[#f5eedc] font-tajawal text-[#3d2b1f] relative overflow-hidden">
      ...
      <div className="flex flex-col items-center">
        <button onClick={handleStart} className="bg-[#d36a3e] text-white px-20 py-5 rounded-3xl text-2xl font-black border-b-8 border-[#3d2b1f] active:border-b-0 active:translate-y-2 transition-all">
          بدء التحدي
        </button>

        {/* جملة الحقوق والهوية تحت الزر مباشرة بشكل باهت */}
        <p className="mt-6 text-[10px] font-bold opacity-30 text-[#3d2b1f] tracking-widest uppercase">
